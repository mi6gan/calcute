...
(function initModule() {
  ...
  this.schemas = {
    ...
    Feedback: new mongoose.Schema({
        ...
        drivers: {
            ...
            helpText: 'не все поля водителей заполнены корректно',
            label: 'Водители',
        ...
        formUrl: { type: String },
        seoQuery: { type: String },
        utmCampaign: { type: String },
        utmSource: { type: String },
        utmSourceId: { type: Number },
        utms: { type: Object },
    },
    {
        timestamps: true
    ...
    DiscountInfo: new mongoose.Schema({
        ...
        company: {
            ...
            helpText: "Выберите страховую компанию, в который у вас заканчивается полис",
        ...
        experience: {
            ...
            validate: [
                function (v) {
                    var val = parseInt(v); 
                    if(this.age) {
                        return Boolean((parseInt(this.age)-val)>=17);
                    }
                    return true;
                },
  ...
  this.schemas.DiscountInfo.methods.display = function portable ( pathName, value ) {
    ...
    return ((value!==null) && (typeof( value ) == 'object')) ? value.label : (value ? String( value ) : null);
  };
